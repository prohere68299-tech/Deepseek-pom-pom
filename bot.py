...
# ==================== CONFIG ====================
BOT_TOKEN = "8686350329:AAGp6ABChaR_2V80QmCNxA3LmGU0nULfpTg"  # ← APNA TOKEN YAHAN DAALO
CHECK_INTERVAL = 3600
    ...
    def setup_handlers(self):
        ...
        def upload_template(m):
            ...
            if m.from_user.id != admin_id:
                return
            self.bot.send_message(m.chat.id, "📤 **Upload Template**\n\nPlease send the `bot.py` file.\nMake sure it contains `YOUR_BOT_TOKEN` placeholder.", parse_mode='Markdown')
